...
""")
	...
	def _add_commands(self):
		...
		event.help(["exit", "quit", "e", "q"], "Exit Luna.")
		event.help("help", "View all commands.")
		event.help("upgrade", "Upgrade Luna.")
		...
		event.help("ddos", "Connect to a Luna botnet.")
		event.help_comment("\nModules:")
		...
		event.help("server", "Load the botnet module for DDos atacks.")
