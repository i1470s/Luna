...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download Luna..."
        sudo git clone https://github.com/i1470s/Luna.git > /dev/null 2>&1 || echo "[!] Could not download Luna."
        ...
        echo "[i] We will now install Luna..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install Luna."
        ...
        git clone https://github.com/i1470s/Luna.git > /dev/null 2>&1 || echo "[!] Please install git"
        cd Luna
